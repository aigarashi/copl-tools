...
\infax{
  \NatPlusIs{\NatMV{n}[_{1}]}{\NatMV{n}[_{2}]}{\NatMV{n}[_{3}]}
}
\infax{
  \NatMultIs{\NatMV{n}[_{1}]}{\NatMV{n}[_{2}]}{\NatMV{n}[_{3}]}
}
...
\infax{
  \CompareNatiLt{\CompareNatiMV{n}[_{1}]}{\CompareNatiMV{n}[_{2}]}
}
...
\infax{
  \CompareNatiiLt{\CompareNatiMV{n}[_{1}]}{\CompareNatiMV{n}[_{2}]}
}
...
\infax{
  \CompareNatiiiLt{\CompareNatiMV{n}[_{1}]}{\CompareNatiMV{n}[_{2}]}
}
...
\infax{
  \EvalNatExpEvalTo{\EvalNatExpMV{e}}{\EvalNatExpMV{n}}
}
\infax{
  \EvalNatExpPlusIs{\NatMV{n}[_{1}]}{\NatMV{n}[_{2}]}{\NatMV{n}[_{3}]}
}
\infax{
  \EvalNatExpMultIs{\NatMV{n}[_{1}]}{\NatMV{n}[_{2}]}{\NatMV{n}[_{3}]}
}
...
\infax{
  \ReduceNatExpOneStepTo{\EvalNatExpMV{e}[_1]}{\EvalNatExpMV{e}[_2]}
}
\infax{
  \ReduceNatExpOneStepToD{\EvalNatExpMV{e}[_1]}{\EvalNatExpMV{e}[_2]}
}
\infax{
  \ReduceNatExpMultiStepTo{\EvalNatExpMV{e}[_1]}{\EvalNatExpMV{e}[_2]}
}
\infax{
  \ReduceNatExpPlusIs{\NatMV{n}[_{1}]}{\NatMV{n}[_{2}]}{\NatMV{n}[_{3}]}
}
\infax{
  \ReduceNatExpMultIs{\NatMV{n}[_{1}]}{\NatMV{n}[_{2}]}{\NatMV{n}[_{3}]}
}
\subsection*{Derivation Rules:}
\typicallabel{T-Int}
...
\infax{
  \EvalMLiEvalTo{\EvalMLiMV{e}}{\EvalMLiMV{v}}
}
\infax{
    \EvalMLiAppBOp{\EvalMLiPlusTerm}{\EvalMLiMV{i}[_{1}]}{\EvalMLiMV{i}[_{2}]}
                  {\EvalMLiMV{i}[_{3}]}
}
\infax{
  \EvalMLiAppBOp{\EvalMLiMinusTerm}{\EvalMLiMV{i}[_{1}]}{\EvalMLiMV{i}[_{2}]}
                  {\EvalMLiMV{i}[_{3}]}
}
\infax{
  \EvalMLiAppBOp{\EvalMLiMultTerm}{\EvalMLiMV{i}[_{1}]}{\EvalMLiMV{i}[_{2}]}
  {\EvalMLiMV{i}[_{3}]}
}
\infax{
  \EvalMLiAppBOp{\EvalMLiLtTerm}{\EvalMLiMV{i}[_{1}]}{\EvalMLiMV{i}[_{2}]}
  {\EvalMLiMV{b}[_{3}]}
}
...
\infax{
  \EvalMLiEvalTo{\EvalMLiMV{e}}{\EvalMLiMV{r}}
}
\infax{
    \EvalMLiAppBOp{\EvalMLiPlusTerm}{\EvalMLiMV{i}[_{1}]}{\EvalMLiMV{i}[_{2}]}
                  {\EvalMLiMV{i}[_{3}]}
...
\infax{
  \EvalMLiiEvalTo{\EvalMLiiMV{env}}{\EvalMLiMV{e}}{\EvalMLiMV{v}}
}
\infax{
    \EvalMLiAppBOp{\EvalMLiPlusTerm}{\EvalMLiMV{i}[_{1}]}{\EvalMLiMV{i}[_{2}]}
                  {\EvalMLiMV{i}[_{3}]}
...
\infax{
  \NamelessMLiiiTranslateTo{\NamelessMLiiiMV{env}[]}{\NamelessMLiiiMV{e}[]}
                             {\NamelessMLiiiMV{d}[]}
}
...
\infax{
  \EvalMLvMatches{\EvalMLvMV{v}[]}{\EvalMLvMV{p}[]}{\EvalMLvMV{env}}
}
\infax{
  \EvalMLvMatches{\EvalMLvMV{v}}{\EvalMLvMV{p}}{\EvalMLvFailTerm}
}
\infax{
  \EvalMLiiEvalTo{\EvalMLiiMV{env}}{\EvalMLiMV{e}}{\EvalMLiMV{v}}
}
...
\infax{
    \TypingMLivTyping{\TypingMLivMV{env}[]}{\TypingMLivMV{e}[]}
                     {\TypingMLivMV{t}[]}
}
...
\infax{
  \EvalContMLiAppK{\EvalContMLiMV{k}[]}{\EvalContMLiMV{v}[_1]}
  {\EvalContMLiMV{v}[_2]}
}
\infax{
  \EvalContMLiEvalTo{\EvalContMLiMV{k}[]}{\EvalContMLiMV{e}[]}
  {\EvalContMLiMV{v}[]}
}
\infax{
  \EvalMLiAppBOp{\EvalMLiPlusTerm}{\EvalMLiMV{i}[_{1}]}{\EvalMLiMV{i}[_{2}]}
...
\subsection*{Judgment Form(s):}
\infax{
  \EvalContMLivEvalTo{\EvalContMLivMV{env}[]}{\EvalContMLivMV{k}[]}
  {\EvalContMLivMV{e}[]}{\EvalContMLivMV{v}[]}
}
\infax{
  \EvalContMLivAppK{\EvalContMLivMV{k}[]}{\EvalContMLivMV{v}[_1]}
  {\EvalContMLivMV{v}[_2]}
}
\infax{
  \EvalMLiAppBOp{\EvalMLiPlusTerm}{\EvalMLiMV{i}[_{1}]}{\EvalMLiMV{i}[_{2}]}
...
\subsection*{Judgment Form(s):}
\infax{
  \EvalDContMLivAppK{\EvalDContMLivMV{k}[]}{\EvalDContMLivMV{kk}[]}
                      {\EvalDContMLivMV{v}[_1]}{\EvalDContMLivMV{v}[_2]}
}
\infax{
  \EvalDContMLivEvalTo{\EvalDContMLivMV{env}[]}{\EvalDContMLivMV{k}[]}
                        {\EvalDContMLivMV{kk}[]}{\EvalDContMLivMV{e}[]}
                        {\EvalDContMLivMV{v}[]}
}
\infax{
  \EvalMLiAppBOp{\EvalMLiPlusTerm}{\EvalMLiMV{i}[_{1}]}{\EvalMLiMV{i}[_{2}]}
...
\subsection*{Judgment Form(s):}
\infax{
  \EvalRefMLiiiEvalTo{\EvalRefMLiiiMV{s}[_1]}{\EvalRefMLiiiMV{env}[]}
                       {\EvalRefMLiiiMV{e}[]}{\EvalRefMLiiiMV{v}[]}
                       {\EvalRefMLiiiMV{s}[_2]}
}
\infax{
  \EvalMLiAppBOp{\EvalMLiPlusTerm}{\EvalMLiMV{i}[_{1}]}{\EvalMLiMV{i}[_{2}]}
...
\infax{
    \WhileAEvalTo{\WhileMV{st}[]}{\WhileMV{a}[]}{\WhileMV{i}[]}
}
\infax{
  \WhileAEvalTo{\WhileMV{st}[]}{\WhileMV{b}[]}{\WhileMV{bv}[]}
}
\infax{
  \WhileExec{\WhileMV{st}[_1]}{\WhileMV{c}}{\WhileMV{st}[_2]}
}
