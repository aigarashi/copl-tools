...
Judgment: 
  ...
  | INTL LT INTL IS TRUE { AppBOp(Lt, Value_of_int $1, Value_of_int $5, Value_of_bool true) }
  | INTL LT INTL IS FALSE { AppBOp(Lt, Value_of_int $1, Value_of_int $6, Value_of_bool false) }
