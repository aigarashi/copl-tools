...
Judgment: 
  ...
  | Val GTGT Cont EVALTO Val { AppK($3, $1, $5) }
  ...
  | Val GTGT error { errAt 3 "Syntax error: continuation expected" }
  | Val GTGT Cont error { errAt 4 "Syntax error: 'evalto' expected" }
  | Val GTGT Cont EVALTO error { errAt 5 "Syntax error: value expected" }
...
partialj :
  ...
  | Val GTGT Cont EVALTO QM { In_AppK($3, $1) }
...
*/
  ...
  | Val GTGT error { errAt 3 "Syntax error: continuation expected" }
  | Val GTGT Cont error { errAt 4 "Syntax error: 'evalto' expected" }
  | Val GTGT Cont EVALTO error { errAt 5 "Syntax error: '?' expected" }
  | SInt PLUS error { errAt 3 "Syntax error: natural number expected" }
  | SInt PLUS SInt error { errAt 4 "Syntax error: \'is\' expected" }
